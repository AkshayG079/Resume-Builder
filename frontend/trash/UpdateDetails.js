...
import { DataState } from '../src/context/Contextprovider';
...
const UpdateDetails = ({ template, handleClose }) => {
  ...
  }, [information, education, workExperience, projects, certificates, skills, summary, setResumeData]);
    ...
    <>
      <form>
          ...
          <Stack direction='row' spacing={2}>
            <Grid container spacing={2} sx={{ mt: 2 }} flexBasis='70%'>
              <Grid item xs={12} sm={10}>
                <TextField fullWidth label="Full Name" variant="outlined" value={ResumeData.information.name || ''} name="name" required onChange={(e) => handleInputChange(e, '', "Information")} />
              </Grid>
              <Grid item xs={12} sm={10}>
                <TextField fullWidth label="Phone" variant="outlined" value={ResumeData.information.phone || ''} name="phone" required type="tel" onChange={(e) => handleInputChange(e, '', "Information")} />
              </Grid>
              <Grid item xs={12} sm={10}>
                <TextField fullWidth label="Email" variant="outlined" value={ResumeData.information.email || ''} name="email" required type="email" onChange={(e) => handleInputChange(e, '', "Information")} />
              </Grid>
              <Grid item xs={12} sm={10}>
                <TextField fullWidth label="Address" variant="outlined" value={ResumeData.information.address || ''} name="address" required onChange={(e) => handleInputChange(e, '', "Information")} />
              </Grid>
            </Grid>
            <Stack flexBasis='20%' padding={2} justifyContent='center'>
              <Box>
                <img src={selectedImage || profile} alt="" height='250px' width='250px' />
              </Box>
              <Button
                component="label"
                role={undefined}
        ...
        <Stack justifyContent='center'>
          <Button variant="contained" size="large" onClick={handleClose}>Save</Button>
        </Stack>
      </form>
    </>
  )
